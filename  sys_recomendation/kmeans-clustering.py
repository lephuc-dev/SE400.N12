...
if len(city_features) == 26:
    data_file_path = './files/analyze-data.json'
    output_clusters_file_path = './kmeans/files/data-with-all-features/clusters-all-features.json'
    output_explored_cities_file_path = './kmeans/files/data-with-all-features/explored-cities-for-all-features-data.txt'
elif len(city_features) == 5:
    data_file_path = './files/set-1.json'
    output_clusters_file_path = './kmeans/files/test-1/clusters-test-1.json'
    output_fixture_file_path = './kmeans/files/test-1/fixture-test-1.json'
    output_explored_cities_file_path = './kmeans/files/test-1/explored-cities-for-test-1.txt'
elif len(city_features) == 4:
    data_file_path = './files/set-2.json'
    output_clusters_file_path = './kmeans/files/test-2/clusters-test-2.json'
    output_fixture_file_path = './kmeans/files/test-2/fixture-test-2.json'
    output_explored_cities_file_path = './kmeans/files/test-2/explored-cities-for-test-2.txt'
else:
    data_file_path = './files/set-3.json'
    output_clusters_file_path = './kmeans/files/test-3/clusters-test-3.json'
    output_fixture_file_path = './kmeans/files/test-3/fixture-test-3.json'
    output_explored_cities_file_path = './kmeans/files/test-3/explored-cities-for-test-3.txt'
