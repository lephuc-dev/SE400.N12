...
def get_recommendations(
    ...
    # The user's destination city cluster id 
...
favorite_cities = ['london', 'amsterdam', 'tokyo', 'rio-de-janeiro', 'sao-paulo']
# The city searched by the user in the application 
